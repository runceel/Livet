...
{
	/// <summary>
	/// Popupクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	...
	/// <summary>
	/// Popupクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class PopupSetStateToSourceAction : TriggerAction<Popup>
	{
        ...
        {
            get { return (PopupUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(PopupUnbindableCanReadProperty), typeof(PopupSetStateToSourceAction), new PropertyMetadata());
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(PopupSetStateToSourceAction), new FrameworkPropertyMetadata(null,FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));
        ...
        protected override void Invoke(object parameter)
        {
            switch (Property)
            {
                case PopupUnbindableCanReadProperty.HasDropShadow:
					if((System.Boolean)Source != AssociatedObject.HasDropShadow)
					{
