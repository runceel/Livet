...
{
	/// <summary>
	/// Trackクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum TrackUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// Trackクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class TrackSetStateToSourceAction : TriggerAction<Track>
	{
		public TrackSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public TrackUnbindableCanReadProperty Property
        {
            get { return (TrackUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(TrackUnbindableCanReadProperty), typeof(TrackSetStateToSourceAction), new PropertyMetadata());
