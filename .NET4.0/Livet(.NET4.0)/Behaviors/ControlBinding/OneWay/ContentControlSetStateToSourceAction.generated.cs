...
{
	/// <summary>
	/// ContentControlクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ContentControlUnbindableCanReadProperty
	{
		HasContent,
		ActualWidth,
		ActualHeight,
	...
	/// <summary>
	/// ContentControlクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ContentControlSetStateToSourceAction : TriggerAction<ContentControl>
	{
		public ContentControlSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ContentControlUnbindableCanReadProperty Property
        {
            get { return (ContentControlUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ContentControlUnbindableCanReadProperty), typeof(ContentControlSetStateToSourceAction), new PropertyMetadata());
