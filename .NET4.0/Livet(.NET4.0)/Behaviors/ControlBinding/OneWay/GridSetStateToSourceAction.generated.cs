...
{
	/// <summary>
	/// Gridクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum GridUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// Gridクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class GridSetStateToSourceAction : TriggerAction<Grid>
	{
		public GridSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public GridUnbindableCanReadProperty Property
        {
            get { return (GridUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(GridUnbindableCanReadProperty), typeof(GridSetStateToSourceAction), new PropertyMetadata());
