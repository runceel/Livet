...
{
	/// <summary>
	/// ListBoxItemクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ListBoxItemUnbindableCanReadProperty
	{
		HasContent,
		ActualWidth,
		ActualHeight,
	...
	/// <summary>
	/// ListBoxItemクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ListBoxItemSetStateToSourceAction : TriggerAction<ListBoxItem>
	{
		public ListBoxItemSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ListBoxItemUnbindableCanReadProperty Property
        {
            get { return (ListBoxItemUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ListBoxItemUnbindableCanReadProperty), typeof(ListBoxItemSetStateToSourceAction), new PropertyMetadata());
