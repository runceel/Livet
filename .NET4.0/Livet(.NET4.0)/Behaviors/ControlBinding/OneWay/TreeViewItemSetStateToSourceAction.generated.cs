...
{
	/// <summary>
	/// TreeViewItemクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum TreeViewItemUnbindableCanReadProperty
	{
		IsSelectionActive,
		HasHeader,
		HasItems,
	...
	/// <summary>
	/// TreeViewItemクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class TreeViewItemSetStateToSourceAction : TriggerAction<TreeViewItem>
	{
		public TreeViewItemSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public TreeViewItemUnbindableCanReadProperty Property
        {
            get { return (TreeViewItemUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(TreeViewItemUnbindableCanReadProperty), typeof(TreeViewItemSetStateToSourceAction), new PropertyMetadata());
