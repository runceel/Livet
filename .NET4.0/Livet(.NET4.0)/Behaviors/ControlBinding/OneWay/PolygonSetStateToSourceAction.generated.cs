...
{
	/// <summary>
	/// Polygonクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum PolygonUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// Polygonクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class PolygonSetStateToSourceAction : TriggerAction<Polygon>
	{
		public PolygonSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public PolygonUnbindableCanReadProperty Property
        {
            get { return (PolygonUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(PolygonUnbindableCanReadProperty), typeof(PolygonSetStateToSourceAction), new PropertyMetadata());
