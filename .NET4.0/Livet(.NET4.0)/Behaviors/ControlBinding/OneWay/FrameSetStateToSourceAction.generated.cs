...
{
	/// <summary>
	/// Frameクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum FrameUnbindableCanReadProperty
	{
		CanGoForward,
		CanGoBack,
		CurrentSource,
	...
	/// <summary>
	/// Frameクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class FrameSetStateToSourceAction : TriggerAction<Frame>
	{
		public FrameSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public FrameUnbindableCanReadProperty Property
        {
            get { return (FrameUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(FrameUnbindableCanReadProperty), typeof(FrameSetStateToSourceAction), new PropertyMetadata());
