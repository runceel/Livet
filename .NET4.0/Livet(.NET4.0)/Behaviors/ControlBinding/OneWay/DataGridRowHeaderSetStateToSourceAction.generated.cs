...
{
	/// <summary>
	/// DataGridRowHeaderクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum DataGridRowHeaderUnbindableCanReadProperty
	{
		IsRowSelected,
		IsPressed,
		HasContent,
	...
	/// <summary>
	/// DataGridRowHeaderクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class DataGridRowHeaderSetStateToSourceAction : TriggerAction<DataGridRowHeader>
	{
		public DataGridRowHeaderSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public DataGridRowHeaderUnbindableCanReadProperty Property
        {
            get { return (DataGridRowHeaderUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(DataGridRowHeaderUnbindableCanReadProperty), typeof(DataGridRowHeaderSetStateToSourceAction), new PropertyMetadata());
