...
{
	/// <summary>
	/// TreeViewクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum TreeViewUnbindableCanReadProperty
	{
		SelectedItem,
		SelectedValue,
		HasItems,
	...
	/// <summary>
	/// TreeViewクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class TreeViewSetStateToSourceAction : TriggerAction<TreeView>
	{
		public TreeViewSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public TreeViewUnbindableCanReadProperty Property
        {
            get { return (TreeViewUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(TreeViewUnbindableCanReadProperty), typeof(TreeViewSetStateToSourceAction), new PropertyMetadata());
