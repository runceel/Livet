...
{
	/// <summary>
	/// ToolBarTrayクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ToolBarTrayUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// ToolBarTrayクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ToolBarTraySetStateToSourceAction : TriggerAction<ToolBarTray>
	{
		public ToolBarTraySetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ToolBarTrayUnbindableCanReadProperty Property
        {
            get { return (ToolBarTrayUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ToolBarTrayUnbindableCanReadProperty), typeof(ToolBarTraySetStateToSourceAction), new PropertyMetadata());
