...
{
	/// <summary>
	/// ListBoxクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ListBoxUnbindableCanReadProperty
	{
		SelectedItems,
		HasItems,
		IsGrouping,
	...
	/// <summary>
	/// ListBoxクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ListBoxSetStateToSourceAction : TriggerAction<ListBox>
	{
		public ListBoxSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ListBoxUnbindableCanReadProperty Property
        {
            get { return (ListBoxUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ListBoxUnbindableCanReadProperty), typeof(ListBoxSetStateToSourceAction), new PropertyMetadata());
