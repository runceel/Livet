...
{
	/// <summary>
	/// RadioButtonクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum RadioButtonUnbindableCanReadProperty
	{
		IsPressed,
		HasContent,
		ActualWidth,
	...
	/// <summary>
	/// RadioButtonクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class RadioButtonSetStateToSourceAction : TriggerAction<RadioButton>
	{
		public RadioButtonSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public RadioButtonUnbindableCanReadProperty Property
        {
            get { return (RadioButtonUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(RadioButtonUnbindableCanReadProperty), typeof(RadioButtonSetStateToSourceAction), new PropertyMetadata());
