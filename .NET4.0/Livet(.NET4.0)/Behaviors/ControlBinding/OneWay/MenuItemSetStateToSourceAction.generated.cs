...
{
	/// <summary>
	/// MenuItemクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	...
	/// <summary>
	/// MenuItemクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class MenuItemSetStateToSourceAction : TriggerAction<MenuItem>
	{
        ...
        {
            get { return (MenuItemUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(MenuItemUnbindableCanReadProperty), typeof(MenuItemSetStateToSourceAction), new PropertyMetadata());
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(MenuItemSetStateToSourceAction), new FrameworkPropertyMetadata(null,FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));
        ...
        protected override void Invoke(object parameter)
        {
            switch (Property)
            {
                ...
                case MenuItemUnbindableCanReadProperty.IsSuspendingPopupAnimation:
					if((System.Boolean)Source != AssociatedObject.IsSuspendingPopupAnimation)
					{
