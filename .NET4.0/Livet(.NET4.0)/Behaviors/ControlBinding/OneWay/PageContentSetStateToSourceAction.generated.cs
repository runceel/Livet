...
{
	/// <summary>
	/// PageContentクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum PageContentUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// PageContentクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class PageContentSetStateToSourceAction : TriggerAction<PageContent>
	{
		public PageContentSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public PageContentUnbindableCanReadProperty Property
        {
            get { return (PageContentUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(PageContentUnbindableCanReadProperty), typeof(PageContentSetStateToSourceAction), new PropertyMetadata());
