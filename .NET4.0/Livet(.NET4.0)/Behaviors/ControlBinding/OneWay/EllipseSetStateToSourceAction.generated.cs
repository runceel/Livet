...
{
	/// <summary>
	/// Ellipseクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum EllipseUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// Ellipseクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class EllipseSetStateToSourceAction : TriggerAction<Ellipse>
	{
		public EllipseSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public EllipseUnbindableCanReadProperty Property
        {
            get { return (EllipseUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(EllipseUnbindableCanReadProperty), typeof(EllipseSetStateToSourceAction), new PropertyMetadata());
