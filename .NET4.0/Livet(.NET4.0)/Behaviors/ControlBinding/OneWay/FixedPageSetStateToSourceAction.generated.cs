...
{
	/// <summary>
	/// FixedPageクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum FixedPageUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// FixedPageクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class FixedPageSetStateToSourceAction : TriggerAction<FixedPage>
	{
		public FixedPageSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public FixedPageUnbindableCanReadProperty Property
        {
            get { return (FixedPageUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(FixedPageUnbindableCanReadProperty), typeof(FixedPageSetStateToSourceAction), new PropertyMetadata());
