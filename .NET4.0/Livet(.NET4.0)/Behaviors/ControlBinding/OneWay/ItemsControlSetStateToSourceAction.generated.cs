...
{
	/// <summary>
	/// ItemsControlクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ItemsControlUnbindableCanReadProperty
	{
		HasItems,
		IsGrouping,
		ActualWidth,
	...
	/// <summary>
	/// ItemsControlクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ItemsControlSetStateToSourceAction : TriggerAction<ItemsControl>
	{
		public ItemsControlSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ItemsControlUnbindableCanReadProperty Property
        {
            get { return (ItemsControlUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ItemsControlUnbindableCanReadProperty), typeof(ItemsControlSetStateToSourceAction), new PropertyMetadata());
