...
{
	/// <summary>
	/// GroupItemクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum GroupItemUnbindableCanReadProperty
	{
		HasContent,
		ActualWidth,
		ActualHeight,
	...
	/// <summary>
	/// GroupItemクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class GroupItemSetStateToSourceAction : TriggerAction<GroupItem>
	{
		public GroupItemSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public GroupItemUnbindableCanReadProperty Property
        {
            get { return (GroupItemUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(GroupItemUnbindableCanReadProperty), typeof(GroupItemSetStateToSourceAction), new PropertyMetadata());
