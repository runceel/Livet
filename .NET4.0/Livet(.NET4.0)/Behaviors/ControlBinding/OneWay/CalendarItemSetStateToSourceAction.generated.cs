...
{
	/// <summary>
	/// CalendarItemクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum CalendarItemUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// CalendarItemクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class CalendarItemSetStateToSourceAction : TriggerAction<CalendarItem>
	{
		public CalendarItemSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public CalendarItemUnbindableCanReadProperty Property
        {
            get { return (CalendarItemUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(CalendarItemUnbindableCanReadProperty), typeof(CalendarItemSetStateToSourceAction), new PropertyMetadata());
