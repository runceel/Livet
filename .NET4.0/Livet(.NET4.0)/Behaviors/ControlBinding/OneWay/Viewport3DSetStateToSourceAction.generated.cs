...
{
	/// <summary>
	/// Viewport3Dクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum Viewport3DUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// Viewport3Dクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class Viewport3DSetStateToSourceAction : TriggerAction<Viewport3D>
	{
		public Viewport3DSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public Viewport3DUnbindableCanReadProperty Property
        {
            get { return (Viewport3DUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(Viewport3DUnbindableCanReadProperty), typeof(Viewport3DSetStateToSourceAction), new PropertyMetadata());
