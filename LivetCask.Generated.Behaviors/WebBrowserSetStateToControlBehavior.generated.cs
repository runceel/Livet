...
namespace Livet.Behaviors.ControlBinding.OneWay
{
	...
	public class WebBrowserSetStateToControlBehavior : Behavior<WebBrowser>
	{
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(WebBrowserSetStateToControlBehavior), new PropertyMetadata(null,new PropertyChangedCallback(SourceChanged)));
