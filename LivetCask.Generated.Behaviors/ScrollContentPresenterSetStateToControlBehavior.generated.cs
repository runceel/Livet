...
namespace Livet.Behaviors.ControlBinding.OneWay
{
	...
	public class ScrollContentPresenterSetStateToControlBehavior : Behavior<ScrollContentPresenter>
	{
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(ScrollContentPresenterSetStateToControlBehavior), new PropertyMetadata(null,new PropertyChangedCallback(SourceChanged)));
