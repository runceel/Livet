...
{
	/// <summary>
	/// FrameworkElementクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	...
	/// <summary>
	/// FrameworkElementクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class FrameworkElementSetStateToSourceAction : TriggerAction<FrameworkElement>
	{
		public FrameworkElementSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public FrameworkElementUnbindableCanReadProperty Property
        {
            get { return (FrameworkElementUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(FrameworkElementUnbindableCanReadProperty), typeof(FrameworkElementSetStateToSourceAction), new PropertyMetadata());
