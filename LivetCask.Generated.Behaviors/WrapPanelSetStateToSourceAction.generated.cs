...
{
	/// <summary>
	/// WrapPanelクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum WrapPanelUnbindableCanReadProperty
	{
	...
	/// <summary>
	/// WrapPanelクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class WrapPanelSetStateToSourceAction : TriggerAction<WrapPanel>
	{
		public WrapPanelSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public WrapPanelUnbindableCanReadProperty Property
        {
            get { return (WrapPanelUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(WrapPanelUnbindableCanReadProperty), typeof(WrapPanelSetStateToSourceAction), new PropertyMetadata());
