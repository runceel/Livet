...
{
	/// <summary>
	/// Canvasクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum CanvasUnbindableCanReadProperty
	{
	...
	/// <summary>
	/// Canvasクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class CanvasSetStateToSourceAction : TriggerAction<Canvas>
	{
		public CanvasSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public CanvasUnbindableCanReadProperty Property
        {
            get { return (CanvasUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(CanvasUnbindableCanReadProperty), typeof(CanvasSetStateToSourceAction), new PropertyMetadata());
