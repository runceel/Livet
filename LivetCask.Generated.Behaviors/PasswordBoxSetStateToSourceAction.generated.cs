...
{
	/// <summary>
	/// PasswordBoxクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum PasswordBoxUnbindableCanReadProperty
	{
		Password,
		SecurePassword,
		IsSelectionActive,
	...
	/// <summary>
	/// PasswordBoxクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class PasswordBoxSetStateToSourceAction : TriggerAction<PasswordBox>
	{
		public PasswordBoxSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public PasswordBoxUnbindableCanReadProperty Property
        {
            get { return (PasswordBoxUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(PasswordBoxUnbindableCanReadProperty), typeof(PasswordBoxSetStateToSourceAction), new PropertyMetadata());
