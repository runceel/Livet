...
{
	/// <summary>
	/// ContextMenuクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ContextMenuUnbindableCanReadProperty
	{
		HasItems,
		IsGrouping,
		ActualWidth,
	...
	/// <summary>
	/// ContextMenuクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ContextMenuSetStateToSourceAction : TriggerAction<ContextMenu>
	{
		public ContextMenuSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ContextMenuUnbindableCanReadProperty Property
        {
            get { return (ContextMenuUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ContextMenuUnbindableCanReadProperty), typeof(ContextMenuSetStateToSourceAction), new PropertyMetadata());
        ...
        protected override void Invoke(object parameter)
        {
            switch (Property)
            {
                ...
                case ContextMenuUnbindableCanReadProperty.IsMouseOver:
                    ...
                    break;
                case ContextMenuUnbindableCanReadProperty.IsStylusOver:
