...
{
	/// <summary>
	/// CheckBoxクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum CheckBoxUnbindableCanReadProperty
	{
		IsPressed,
		HasContent,
		ActualWidth,
	...
	/// <summary>
	/// CheckBoxクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class CheckBoxSetStateToSourceAction : TriggerAction<CheckBox>
	{
		public CheckBoxSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public CheckBoxUnbindableCanReadProperty Property
        {
            get { return (CheckBoxUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(CheckBoxUnbindableCanReadProperty), typeof(CheckBoxSetStateToSourceAction), new PropertyMetadata());
