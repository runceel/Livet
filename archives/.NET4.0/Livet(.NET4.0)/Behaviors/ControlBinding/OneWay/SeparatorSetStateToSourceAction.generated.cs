...
{
	/// <summary>
	/// Separatorクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum SeparatorUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// Separatorクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class SeparatorSetStateToSourceAction : TriggerAction<Separator>
	{
		public SeparatorSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public SeparatorUnbindableCanReadProperty Property
        {
            get { return (SeparatorUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(SeparatorUnbindableCanReadProperty), typeof(SeparatorSetStateToSourceAction), new PropertyMetadata());
