...
{
	/// <summary>
	/// ToolTipクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ToolTipUnbindableCanReadProperty
	{
		HasContent,
		ActualWidth,
		ActualHeight,
	...
	/// <summary>
	/// ToolTipクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ToolTipSetStateToSourceAction : TriggerAction<ToolTip>
	{
		public ToolTipSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ToolTipUnbindableCanReadProperty Property
        {
            get { return (ToolTipUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ToolTipUnbindableCanReadProperty), typeof(ToolTipSetStateToSourceAction), new PropertyMetadata());
