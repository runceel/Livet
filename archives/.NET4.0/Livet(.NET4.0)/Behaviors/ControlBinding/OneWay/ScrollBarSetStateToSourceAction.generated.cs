...
{
	/// <summary>
	/// ScrollBarクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ScrollBarUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// ScrollBarクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ScrollBarSetStateToSourceAction : TriggerAction<ScrollBar>
	{
		public ScrollBarSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ScrollBarUnbindableCanReadProperty Property
        {
            get { return (ScrollBarUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ScrollBarUnbindableCanReadProperty), typeof(ScrollBarSetStateToSourceAction), new PropertyMetadata());
