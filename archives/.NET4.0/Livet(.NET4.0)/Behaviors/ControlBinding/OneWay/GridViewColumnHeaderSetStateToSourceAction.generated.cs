...
{
	/// <summary>
	/// GridViewColumnHeaderクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum GridViewColumnHeaderUnbindableCanReadProperty
	{
		IsPressed,
		HasContent,
		ActualWidth,
	...
	/// <summary>
	/// GridViewColumnHeaderクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class GridViewColumnHeaderSetStateToSourceAction : TriggerAction<GridViewColumnHeader>
	{
		public GridViewColumnHeaderSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public GridViewColumnHeaderUnbindableCanReadProperty Property
        {
            get { return (GridViewColumnHeaderUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(GridViewColumnHeaderUnbindableCanReadProperty), typeof(GridViewColumnHeaderSetStateToSourceAction), new PropertyMetadata());
