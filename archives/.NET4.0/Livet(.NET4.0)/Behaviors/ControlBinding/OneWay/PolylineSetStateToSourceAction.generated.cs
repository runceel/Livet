...
{
	/// <summary>
	/// Polylineクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum PolylineUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// Polylineクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class PolylineSetStateToSourceAction : TriggerAction<Polyline>
	{
		public PolylineSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public PolylineUnbindableCanReadProperty Property
        {
            get { return (PolylineUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(PolylineUnbindableCanReadProperty), typeof(PolylineSetStateToSourceAction), new PropertyMetadata());
