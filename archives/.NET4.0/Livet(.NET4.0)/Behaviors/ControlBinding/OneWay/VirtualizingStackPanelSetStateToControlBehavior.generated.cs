...
namespace Livet.Behaviors.ControlBinding.OneWay
{
	...
	public class VirtualizingStackPanelSetStateToControlBehavior : Behavior<VirtualizingStackPanel>
	{
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(VirtualizingStackPanelSetStateToControlBehavior), new FrameworkPropertyMetadata(null,new PropertyChangedCallback(SourceChanged)));
