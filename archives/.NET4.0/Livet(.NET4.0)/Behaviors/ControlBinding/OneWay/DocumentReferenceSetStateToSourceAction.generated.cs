...
{
	/// <summary>
	/// DocumentReferenceクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum DocumentReferenceUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// DocumentReferenceクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class DocumentReferenceSetStateToSourceAction : TriggerAction<DocumentReference>
	{
		public DocumentReferenceSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public DocumentReferenceUnbindableCanReadProperty Property
        {
            get { return (DocumentReferenceUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(DocumentReferenceUnbindableCanReadProperty), typeof(DocumentReferenceSetStateToSourceAction), new PropertyMetadata());
