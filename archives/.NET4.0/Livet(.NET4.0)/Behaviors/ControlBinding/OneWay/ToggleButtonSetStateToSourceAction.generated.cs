...
{
	/// <summary>
	/// ToggleButtonクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ToggleButtonUnbindableCanReadProperty
	{
		IsPressed,
		HasContent,
		ActualWidth,
	...
	/// <summary>
	/// ToggleButtonクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ToggleButtonSetStateToSourceAction : TriggerAction<ToggleButton>
	{
		public ToggleButtonSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ToggleButtonUnbindableCanReadProperty Property
        {
            get { return (ToggleButtonUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ToggleButtonUnbindableCanReadProperty), typeof(ToggleButtonSetStateToSourceAction), new PropertyMetadata());
