...
{
	/// <summary>
	/// BulletDecoratorクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum BulletDecoratorUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// BulletDecoratorクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class BulletDecoratorSetStateToSourceAction : TriggerAction<BulletDecorator>
	{
		public BulletDecoratorSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public BulletDecoratorUnbindableCanReadProperty Property
        {
            get { return (BulletDecoratorUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(BulletDecoratorUnbindableCanReadProperty), typeof(BulletDecoratorSetStateToSourceAction), new PropertyMetadata());
