...
{
	/// <summary>
	/// CalendarButtonクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum CalendarButtonUnbindableCanReadProperty
	{
		HasSelectedDays,
		IsInactive,
		IsDefaulted,
	...
	/// <summary>
	/// CalendarButtonクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class CalendarButtonSetStateToSourceAction : TriggerAction<CalendarButton>
	{
		public CalendarButtonSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public CalendarButtonUnbindableCanReadProperty Property
        {
            get { return (CalendarButtonUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(CalendarButtonUnbindableCanReadProperty), typeof(CalendarButtonSetStateToSourceAction), new PropertyMetadata());
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(CalendarButtonSetStateToSourceAction), new FrameworkPropertyMetadata(null,FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));

        protected override void Invoke(object parameter)
        {
            switch (Property)
            {
                case CalendarButtonUnbindableCanReadProperty.HasSelectedDays:
					if((System.Boolean)Source != AssociatedObject.HasSelectedDays)
					{
						Source = AssociatedObject.HasSelectedDays;
					}
                    break;
                case CalendarButtonUnbindableCanReadProperty.IsInactive:
					if((System.Boolean)Source != AssociatedObject.IsInactive)
					{
						Source = AssociatedObject.IsInactive;
					}
                    break;
                case CalendarButtonUnbindableCanReadProperty.IsDefaulted:
					if((System.Boolean)Source != AssociatedObject.IsDefaulted)
					{
						Source = AssociatedObject.IsDefaulted;
					}
                    break;
                case CalendarButtonUnbindableCanReadProperty.IsPressed:
					if((System.Boolean)Source != AssociatedObject.IsPressed)
					{
						Source = AssociatedObject.IsPressed;
					}
                    break;
                case CalendarButtonUnbindableCanReadProperty.HasContent:
					if((System.Boolean)Source != AssociatedObject.HasContent)
					{
						Source = AssociatedObject.HasContent;
					}
                    break;
                case CalendarButtonUnbindableCanReadProperty.ActualWidth:
					if((System.Double)Source != AssociatedObject.ActualWidth)
					{
						Source = AssociatedObject.ActualWidth;
					}
                    break;
                case CalendarButtonUnbindableCanReadProperty.ActualHeight:
					if((System.Double)Source != AssociatedObject.ActualHeight)
					{
						Source = AssociatedObject.ActualHeight;
					}
                    break;
                case CalendarButtonUnbindableCanReadProperty.IsInitialized:
					if((System.Boolean)Source != AssociatedObject.IsInitialized)
					{
						Source = AssociatedObject.IsInitialized;
					}
                    break;
                case CalendarButtonUnbindableCanReadProperty.IsLoaded:
					if((System.Boolean)Source != AssociatedObject.IsLoaded)
					{
						Source = AssociatedObject.IsLoaded;
					}
                    break;
                case CalendarButtonUnbindableCanReadProperty.HasAnimatedProperties:
					if((System.Boolean)Source != AssociatedObject.HasAnimatedProperties)
					{
						Source = AssociatedObject.HasAnimatedProperties;
					}
                    break;
                case CalendarButtonUnbindableCanReadProperty.IsMeasureValid:
					if((System.Boolean)Source != AssociatedObject.IsMeasureValid)
					{
						Source = AssociatedObject.IsMeasureValid;
					}
                    break;
                case CalendarButtonUnbindableCanReadProperty.IsArrangeValid:
					if((System.Boolean)Source != AssociatedObject.IsArrangeValid)
					{
						Source = AssociatedObject.IsArrangeValid;
					}
                    break;
                case CalendarButtonUnbindableCanReadProperty.IsMouseDirectlyOver:
