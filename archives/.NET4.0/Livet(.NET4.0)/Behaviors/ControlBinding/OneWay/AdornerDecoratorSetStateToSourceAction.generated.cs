...
{
	/// <summary>
	/// AdornerDecoratorクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum AdornerDecoratorUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// AdornerDecoratorクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class AdornerDecoratorSetStateToSourceAction : TriggerAction<AdornerDecorator>
	{
		public AdornerDecoratorSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public AdornerDecoratorUnbindableCanReadProperty Property
        {
            get { return (AdornerDecoratorUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(AdornerDecoratorUnbindableCanReadProperty), typeof(AdornerDecoratorSetStateToSourceAction), new PropertyMetadata());
