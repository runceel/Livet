...
namespace Livet.Converters
{
    ...
    public class AutomationEventsAndBooleanConverter : IValueConverter
    {
        ...
        public object ConvertBack(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
			...
			switch(enumValue.ToString())
			{
				...
				case "LiveRegionChanged":
					if (_isConvertBackWhenLiveRegionChangedSet)
					{
						return ConvertBackWhenLiveRegionChanged;
					}
					break;
				default:
        ...
        private bool _isConvertBackWhenLiveRegionChangedSet;
        private bool _convertBackWhenLiveRegionChanged;
		/// <summary>
        /// AutomationEventsの値がLiveRegionChangedの際True/Falseいずれに変換するのかを指定、または取得します。<br/>
        /// この値が設定されておらず、ConvertBackDefaultBooleanValueが設定されている場合はConvertBackDefaultBooleanValueに従います。
        /// </summary>
        public bool ConvertBackWhenLiveRegionChanged
        {
            get
            {
                return _convertBackWhenLiveRegionChanged;
            }
            set
            {
                _convertBackWhenLiveRegionChanged = value;
                _isConvertBackWhenLiveRegionChangedSet = true;
            }
        }
    }
}