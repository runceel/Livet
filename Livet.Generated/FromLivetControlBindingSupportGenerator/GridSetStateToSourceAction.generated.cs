...
namespace Livet.Behaviors.ControlBinding.OneWay
{
	...
	public class GridSetStateToSourceAction : TriggerAction<Grid>
	{
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(GridSetStateToSourceAction), new PropertyMetadata(null));

        protected override void Invoke(object parameter)
        {
            switch (Property)
            {
                case GridUnbindableCanReadProperty.HasLogicalOrientationPublic:
