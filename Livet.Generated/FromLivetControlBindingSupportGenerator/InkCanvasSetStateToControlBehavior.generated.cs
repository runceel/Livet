...
namespace Livet.Behaviors.ControlBinding.OneWay
{
	...
	public class InkCanvasSetStateToControlBehavior : Behavior<InkCanvas>
	{
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(InkCanvasSetStateToControlBehavior), new PropertyMetadata(null,new PropertyChangedCallback(SourceChanged)));
