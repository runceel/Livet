...
namespace Livet.Behaviors.ControlBinding.OneWay
{
	...
	public class DataGridRowsPresenterSetStateToControlBehavior : Behavior<DataGridRowsPresenter>
	{
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(DataGridRowsPresenterSetStateToControlBehavior), new PropertyMetadata(null,new PropertyChangedCallback(SourceChanged)));
