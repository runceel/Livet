...
namespace Livet.Behaviors.ControlBinding.OneWay
{
	...
	public class StackPanelSetStateToControlBehavior : Behavior<StackPanel>
	{
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(StackPanelSetStateToControlBehavior), new PropertyMetadata(null,new PropertyChangedCallback(SourceChanged)));
