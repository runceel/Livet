...
{
	/// <summary>
	/// FlowDocumentScrollViewerクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum FlowDocumentScrollViewerUnbindableCanReadProperty
	{
		CanIncreaseZoom,
		CanDecreaseZoom,
		IsSelectionActive,
	...
	/// <summary>
	/// FlowDocumentScrollViewerクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class FlowDocumentScrollViewerSetStateToSourceAction : TriggerAction<FlowDocumentScrollViewer>
	{
		public FlowDocumentScrollViewerSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public FlowDocumentScrollViewerUnbindableCanReadProperty Property
        {
            get { return (FlowDocumentScrollViewerUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(FlowDocumentScrollViewerUnbindableCanReadProperty), typeof(FlowDocumentScrollViewerSetStateToSourceAction), new PropertyMetadata());
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(FlowDocumentScrollViewerSetStateToSourceAction), new PropertyMetadata(null));

        protected override void Invoke(object parameter)
        {
            switch (Property)
            {
                case FlowDocumentScrollViewerUnbindableCanReadProperty.CanIncreaseZoom:
					if((System.Boolean)Source != AssociatedObject.CanIncreaseZoom)
					{
						Source = AssociatedObject.CanIncreaseZoom;
					}
                    break;
                case FlowDocumentScrollViewerUnbindableCanReadProperty.CanDecreaseZoom:
					if((System.Boolean)Source != AssociatedObject.CanDecreaseZoom)
					{
						Source = AssociatedObject.CanDecreaseZoom;
					}
                    break;
                case FlowDocumentScrollViewerUnbindableCanReadProperty.IsSelectionActive:
					if((System.Boolean)Source != AssociatedObject.IsSelectionActive)
					{
						Source = AssociatedObject.IsSelectionActive;
					}
                    break;
                case FlowDocumentScrollViewerUnbindableCanReadProperty.ActualWidth:
					if((System.Double)Source != AssociatedObject.ActualWidth)
					{
						Source = AssociatedObject.ActualWidth;
					}
                    break;
                case FlowDocumentScrollViewerUnbindableCanReadProperty.ActualHeight:
					if((System.Double)Source != AssociatedObject.ActualHeight)
					{
						Source = AssociatedObject.ActualHeight;
					}
                    break;
                case FlowDocumentScrollViewerUnbindableCanReadProperty.IsInitialized:
					if((System.Boolean)Source != AssociatedObject.IsInitialized)
					{
						Source = AssociatedObject.IsInitialized;
					}
                    break;
                case FlowDocumentScrollViewerUnbindableCanReadProperty.IsLoaded:
					if((System.Boolean)Source != AssociatedObject.IsLoaded)
					{
						Source = AssociatedObject.IsLoaded;
					}
                    break;
                case FlowDocumentScrollViewerUnbindableCanReadProperty.HasAnimatedProperties:
					if((System.Boolean)Source != AssociatedObject.HasAnimatedProperties)
					{
						Source = AssociatedObject.HasAnimatedProperties;
					}
                    break;
                case FlowDocumentScrollViewerUnbindableCanReadProperty.IsMeasureValid:
					if((System.Boolean)Source != AssociatedObject.IsMeasureValid)
					{
						Source = AssociatedObject.IsMeasureValid;
					}
                    break;
                case FlowDocumentScrollViewerUnbindableCanReadProperty.IsArrangeValid:
					if((System.Boolean)Source != AssociatedObject.IsArrangeValid)
					{
						Source = AssociatedObject.IsArrangeValid;
					}
                    break;
                case FlowDocumentScrollViewerUnbindableCanReadProperty.IsMouseDirectlyOver:
					if((System.Boolean)Source != AssociatedObject.IsMouseDirectlyOver)
					{
						Source = AssociatedObject.IsMouseDirectlyOver;
					}
                    break;
                case FlowDocumentScrollViewerUnbindableCanReadProperty.IsMouseOver:
					if((System.Boolean)Source != AssociatedObject.IsMouseOver)
					{
						Source = AssociatedObject.IsMouseOver;
					}
                    break;
                case FlowDocumentScrollViewerUnbindableCanReadProperty.IsStylusOver:
