...
namespace Livet.Behaviors.ControlBinding.OneWay
{
	...
	public class MediaElementSetStateToControlBehavior : Behavior<MediaElement>
	{
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(MediaElementSetStateToControlBehavior), new PropertyMetadata(null,new PropertyChangedCallback(SourceChanged)));
