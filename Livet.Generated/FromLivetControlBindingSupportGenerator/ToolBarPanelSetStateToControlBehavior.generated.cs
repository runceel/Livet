...
namespace Livet.Behaviors.ControlBinding.OneWay
{
	...
	public class ToolBarPanelSetStateToControlBehavior : Behavior<ToolBarPanel>
	{
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(ToolBarPanelSetStateToControlBehavior), new PropertyMetadata(null,new PropertyChangedCallback(SourceChanged)));
