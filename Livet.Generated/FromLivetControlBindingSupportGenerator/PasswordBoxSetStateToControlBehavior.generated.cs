...
namespace Livet.Behaviors.ControlBinding.OneWay
{
	...
	public class PasswordBoxSetStateToControlBehavior : Behavior<PasswordBox>
	{
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(PasswordBoxSetStateToControlBehavior), new PropertyMetadata(null,new PropertyChangedCallback(SourceChanged)));
