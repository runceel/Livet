...
{
	/// <summary>
	/// RepeatButtonクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum RepeatButtonUnbindableCanReadProperty
	{
		IsPressed,
		HasContent,
		ActualWidth,
	...
	/// <summary>
	/// RepeatButtonクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class RepeatButtonSetStateToSourceAction : TriggerAction<RepeatButton>
	{
		public RepeatButtonSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public RepeatButtonUnbindableCanReadProperty Property
        {
            get { return (RepeatButtonUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(RepeatButtonUnbindableCanReadProperty), typeof(RepeatButtonSetStateToSourceAction), new PropertyMetadata());
