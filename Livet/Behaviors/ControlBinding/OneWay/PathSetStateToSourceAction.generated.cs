...
{
	/// <summary>
	/// Pathクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum PathUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// Pathクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class PathSetStateToSourceAction : TriggerAction<Path>
	{
		public PathSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public PathUnbindableCanReadProperty Property
        {
            get { return (PathUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(PathUnbindableCanReadProperty), typeof(PathSetStateToSourceAction), new PropertyMetadata());
