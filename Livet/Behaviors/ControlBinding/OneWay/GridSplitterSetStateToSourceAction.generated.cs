...
{
	/// <summary>
	/// GridSplitterクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum GridSplitterUnbindableCanReadProperty
	{
		IsDragging,
		ActualWidth,
		ActualHeight,
	...
	/// <summary>
	/// GridSplitterクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class GridSplitterSetStateToSourceAction : TriggerAction<GridSplitter>
	{
		public GridSplitterSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public GridSplitterUnbindableCanReadProperty Property
        {
            get { return (GridSplitterUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(GridSplitterUnbindableCanReadProperty), typeof(GridSplitterSetStateToSourceAction), new PropertyMetadata());
