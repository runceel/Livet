...
{
	/// <summary>
	/// ComboBoxItemクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ComboBoxItemUnbindableCanReadProperty
	{
		IsHighlighted,
		HasContent,
		ActualWidth,
	...
	/// <summary>
	/// ComboBoxItemクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ComboBoxItemSetStateToSourceAction : TriggerAction<ComboBoxItem>
	{
		public ComboBoxItemSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ComboBoxItemUnbindableCanReadProperty Property
        {
            get { return (ComboBoxItemUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ComboBoxItemUnbindableCanReadProperty), typeof(ComboBoxItemSetStateToSourceAction), new PropertyMetadata());
