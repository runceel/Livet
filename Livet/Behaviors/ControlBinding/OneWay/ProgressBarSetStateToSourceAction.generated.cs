...
{
	/// <summary>
	/// ProgressBarクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ProgressBarUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// ProgressBarクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ProgressBarSetStateToSourceAction : TriggerAction<ProgressBar>
	{
		public ProgressBarSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ProgressBarUnbindableCanReadProperty Property
        {
            get { return (ProgressBarUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ProgressBarUnbindableCanReadProperty), typeof(ProgressBarSetStateToSourceAction), new PropertyMetadata());
