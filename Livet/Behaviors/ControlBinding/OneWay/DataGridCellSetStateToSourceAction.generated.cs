...
{
	/// <summary>
	/// DataGridCellクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum DataGridCellUnbindableCanReadProperty
	{
		IsReadOnly,
		HasContent,
		ActualWidth,
	...
	/// <summary>
	/// DataGridCellクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class DataGridCellSetStateToSourceAction : TriggerAction<DataGridCell>
	{
		public DataGridCellSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public DataGridCellUnbindableCanReadProperty Property
        {
            get { return (DataGridCellUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(DataGridCellUnbindableCanReadProperty), typeof(DataGridCellSetStateToSourceAction), new PropertyMetadata());
