...
{
	/// <summary>
	/// ItemsPresenterクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ItemsPresenterUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// ItemsPresenterクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ItemsPresenterSetStateToSourceAction : TriggerAction<ItemsPresenter>
	{
		public ItemsPresenterSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ItemsPresenterUnbindableCanReadProperty Property
        {
            get { return (ItemsPresenterUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ItemsPresenterUnbindableCanReadProperty), typeof(ItemsPresenterSetStateToSourceAction), new PropertyMetadata());
