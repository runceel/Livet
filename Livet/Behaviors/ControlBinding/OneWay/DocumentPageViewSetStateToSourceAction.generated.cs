...
{
	/// <summary>
	/// DocumentPageViewクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum DocumentPageViewUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// DocumentPageViewクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class DocumentPageViewSetStateToSourceAction : TriggerAction<DocumentPageView>
	{
		public DocumentPageViewSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public DocumentPageViewUnbindableCanReadProperty Property
        {
            get { return (DocumentPageViewUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(DocumentPageViewUnbindableCanReadProperty), typeof(DocumentPageViewSetStateToSourceAction), new PropertyMetadata());
