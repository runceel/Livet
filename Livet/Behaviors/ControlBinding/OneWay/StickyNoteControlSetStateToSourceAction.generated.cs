...
{
	/// <summary>
	/// StickyNoteControlクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	...
	/// <summary>
	/// StickyNoteControlクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class StickyNoteControlSetStateToSourceAction : TriggerAction<StickyNoteControl>
	{
        ...
        {
            get { return (StickyNoteControlUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(StickyNoteControlUnbindableCanReadProperty), typeof(StickyNoteControlSetStateToSourceAction), new PropertyMetadata());
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(StickyNoteControlSetStateToSourceAction), new FrameworkPropertyMetadata(null,FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));
        ...
        protected override void Invoke(object parameter)
        {
            switch (Property)
            {
                case StickyNoteControlUnbindableCanReadProperty.Author:
					if((System.String)Source != AssociatedObject.Author)
					{
                ...
                case StickyNoteControlUnbindableCanReadProperty.IsMouseOverAnchor:
					if((System.Boolean)Source != AssociatedObject.IsMouseOverAnchor)
					{
