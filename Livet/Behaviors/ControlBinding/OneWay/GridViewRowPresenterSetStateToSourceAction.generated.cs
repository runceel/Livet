...
{
	/// <summary>
	/// GridViewRowPresenterクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum GridViewRowPresenterUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// GridViewRowPresenterクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class GridViewRowPresenterSetStateToSourceAction : TriggerAction<GridViewRowPresenter>
	{
		public GridViewRowPresenterSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public GridViewRowPresenterUnbindableCanReadProperty Property
        {
            get { return (GridViewRowPresenterUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(GridViewRowPresenterUnbindableCanReadProperty), typeof(GridViewRowPresenterSetStateToSourceAction), new PropertyMetadata());
