...
{
	/// <summary>
	/// HeaderedItemsControlクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum HeaderedItemsControlUnbindableCanReadProperty
	{
		HasHeader,
		HasItems,
		IsGrouping,
	...
	/// <summary>
	/// HeaderedItemsControlクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class HeaderedItemsControlSetStateToSourceAction : TriggerAction<HeaderedItemsControl>
	{
		public HeaderedItemsControlSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public HeaderedItemsControlUnbindableCanReadProperty Property
        {
            get { return (HeaderedItemsControlUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(HeaderedItemsControlUnbindableCanReadProperty), typeof(HeaderedItemsControlSetStateToSourceAction), new PropertyMetadata());
