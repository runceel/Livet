...
{
	/// <summary>
	/// MediaElementクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	...
	/// <summary>
	/// MediaElementクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class MediaElementSetStateToSourceAction : TriggerAction<MediaElement>
	{
        ...
        {
            get { return (MediaElementUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(MediaElementUnbindableCanReadProperty), typeof(MediaElementSetStateToSourceAction), new PropertyMetadata());
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(object), typeof(MediaElementSetStateToSourceAction), new FrameworkPropertyMetadata(null,FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));
        ...
        protected override void Invoke(object parameter)
        {
            switch (Property)
            {
                ...
                case MediaElementUnbindableCanReadProperty.SpeedRatio:
					if((System.Double)Source != AssociatedObject.SpeedRatio)
					{
