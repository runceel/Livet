...
{
	/// <summary>
	/// Borderクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum BorderUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// Borderクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class BorderSetStateToSourceAction : TriggerAction<Border>
	{
		public BorderSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public BorderUnbindableCanReadProperty Property
        {
            get { return (BorderUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(BorderUnbindableCanReadProperty), typeof(BorderSetStateToSourceAction), new PropertyMetadata());
