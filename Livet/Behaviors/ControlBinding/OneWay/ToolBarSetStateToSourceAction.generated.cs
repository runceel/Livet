...
{
	/// <summary>
	/// ToolBarクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ToolBarUnbindableCanReadProperty
	{
		HasOverflowItems,
		HasHeader,
		HasItems,
	...
	/// <summary>
	/// ToolBarクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ToolBarSetStateToSourceAction : TriggerAction<ToolBar>
	{
		public ToolBarSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ToolBarUnbindableCanReadProperty Property
        {
            get { return (ToolBarUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ToolBarUnbindableCanReadProperty), typeof(ToolBarSetStateToSourceAction), new PropertyMetadata());
