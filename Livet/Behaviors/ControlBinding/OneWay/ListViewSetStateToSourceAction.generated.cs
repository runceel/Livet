...
{
	/// <summary>
	/// ListViewクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ListViewUnbindableCanReadProperty
	{
		SelectedItems,
		HasItems,
		IsGrouping,
	...
	/// <summary>
	/// ListViewクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ListViewSetStateToSourceAction : TriggerAction<ListView>
	{
		public ListViewSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ListViewUnbindableCanReadProperty Property
        {
            get { return (ListViewUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ListViewUnbindableCanReadProperty), typeof(ListViewSetStateToSourceAction), new PropertyMetadata());
