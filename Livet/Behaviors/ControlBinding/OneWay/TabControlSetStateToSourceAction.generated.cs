...
{
	/// <summary>
	/// TabControlクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum TabControlUnbindableCanReadProperty
	{
		SelectedContent,
	...
	/// <summary>
	/// TabControlクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class TabControlSetStateToSourceAction : TriggerAction<TabControl>
	{
		public TabControlSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public TabControlUnbindableCanReadProperty Property
        {
            get { return (TabControlUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(TabControlUnbindableCanReadProperty), typeof(TabControlSetStateToSourceAction), new PropertyMetadata());
