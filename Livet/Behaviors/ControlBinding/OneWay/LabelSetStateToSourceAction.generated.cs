...
{
	/// <summary>
	/// Labelクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum LabelUnbindableCanReadProperty
	{
		HasContent,
		ActualWidth,
		ActualHeight,
	...
	/// <summary>
	/// Labelクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class LabelSetStateToSourceAction : TriggerAction<Label>
	{
		public LabelSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public LabelUnbindableCanReadProperty Property
        {
            get { return (LabelUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(LabelUnbindableCanReadProperty), typeof(LabelSetStateToSourceAction), new PropertyMetadata());
