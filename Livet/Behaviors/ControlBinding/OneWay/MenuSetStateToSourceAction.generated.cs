...
{
	/// <summary>
	/// Menuクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum MenuUnbindableCanReadProperty
	{
		HasItems,
		IsGrouping,
		ActualWidth,
	...
	/// <summary>
	/// Menuクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class MenuSetStateToSourceAction : TriggerAction<Menu>
	{
		public MenuSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public MenuUnbindableCanReadProperty Property
        {
            get { return (MenuUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(MenuUnbindableCanReadProperty), typeof(MenuSetStateToSourceAction), new PropertyMetadata());
