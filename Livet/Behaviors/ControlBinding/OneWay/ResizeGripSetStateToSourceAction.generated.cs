...
{
	/// <summary>
	/// ResizeGripクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum ResizeGripUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// ResizeGripクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class ResizeGripSetStateToSourceAction : TriggerAction<ResizeGrip>
	{
		public ResizeGripSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public ResizeGripUnbindableCanReadProperty Property
        {
            get { return (ResizeGripUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(ResizeGripUnbindableCanReadProperty), typeof(ResizeGripSetStateToSourceAction), new PropertyMetadata());
