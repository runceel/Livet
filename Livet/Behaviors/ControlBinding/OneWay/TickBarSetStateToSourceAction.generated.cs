...
{
	/// <summary>
	/// TickBarクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum TickBarUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// TickBarクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class TickBarSetStateToSourceAction : TriggerAction<TickBar>
	{
		public TickBarSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public TickBarUnbindableCanReadProperty Property
        {
            get { return (TickBarUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(TickBarUnbindableCanReadProperty), typeof(TickBarSetStateToSourceAction), new PropertyMetadata());
