...
{
	/// <summary>
	/// AdornerLayerクラスの、標準ではバインドできないプロパティを表します。
	/// </summary>
	public enum AdornerLayerUnbindableCanReadProperty
	{
		ActualWidth,
		ActualHeight,
		IsInitialized,
	...
	/// <summary>
	/// AdornerLayerクラスのバインドできないプロパティから、値を指定されたソースに反映するためのアクションです。
	/// </summary>
	public class AdornerLayerSetStateToSourceAction : TriggerAction<AdornerLayer>
	{
		public AdornerLayerSetStateToSourceAction()
		{
		}
		...
		/// </summary>
		public AdornerLayerUnbindableCanReadProperty Property
        {
            get { return (AdornerLayerUnbindableCanReadProperty)GetValue(PropertyProperty); }
            set { SetValue(PropertyProperty, value); }
        }

        public static readonly DependencyProperty PropertyProperty =
            DependencyProperty.Register("Property", typeof(AdornerLayerUnbindableCanReadProperty), typeof(AdornerLayerSetStateToSourceAction), new PropertyMetadata());
